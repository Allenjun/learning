...
//        producer.createTopic(producer.getCreateTopicKey(), "TopicTest", 1);
        Message message = new Message("TopicTest", "tagsA", "Hello MQ".getBytes(RemotingHelper.DEFAULT_CHARSET));
    ...
    public void queueSelectorSend() {
        ...
        producer.setNamesrvAddr("192.168.30.130:9876");
        producer.start();
        Message message = new Message("TopicTest", "tagsA", String.valueOf(System.currentTimeMillis()),

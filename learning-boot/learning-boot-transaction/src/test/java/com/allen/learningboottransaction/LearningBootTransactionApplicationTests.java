...
public class LearningBootTransactionApplicationTests {
    ...
    public void test1() {
        ...
        System.out.println(
                MessageFormat
                        .format("添加书本数据，id = {1}, title = {0}", bookDO.getTitle(), bookDO.getId()));
        System.out.println(
                MessageFormat.format("添加用户数据，id = {1}, name = {0}", userDO.getName(), userDO.getId()));
    }
    ...
    public void test2() {
        ...
        System.out.println(
                MessageFormat.format(
                        "添加教师数据，id = {1}, name = {0}", teacherDO.getName(), teacherDO.getId()));
    }

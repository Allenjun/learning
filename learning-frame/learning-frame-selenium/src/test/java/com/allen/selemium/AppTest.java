...
public class AppTest {
    ...
    public void selecnium() {
        System.setProperty(
                ...
                "E:\\Program Files\\IT\\chromedriver_win32\\chromedriver.exe");
        ...
        try {
            ...
            //        driver.manage().addCookie(new Cookie("RNKEY",
            // "40859743*68067497,1190152786,3363277230,1"));
            //        driver.manage().addCookie(new Cookie("il",
            // "v1lqEenPUZsxsSe3SDl38ibM1mJ9DIYaaC1swQn9jQAKAxNTk2MDI2MjMzYWdyNmFNUzdoTnFqa2VaNWEwQnc3SWZldlZKZWpWU09RRk9uSkdCdQ.. "));
